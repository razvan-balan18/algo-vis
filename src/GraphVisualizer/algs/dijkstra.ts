...
export function dijkstra(grid: Cell[][], start: Coordinate, end: Coordinate): AlgorithmResult {
    ...
    frontier.push({ row: start.row, col: start.col }, 0);
        ...
        for (const [dr, dc] of directions) {
            ...
            if (
                ...
                if (newDist < (dist.get(nk) ?? Infinity)) {
                    ...
                    frontier.push({ row: newRow, col: newCol }, newDist);
                }
            }
        }
    }
